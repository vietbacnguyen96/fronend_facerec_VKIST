...
net = dnn.readNetFromONNX( path + 'utils/caffe/models/onnx/version-RFB-320_simplified.onnx')  # onnx version
...
def inference(net, frame):
    ...
    boxes, labels, probs = predict(frame.shape[1], frame.shape[0], scores, boxes, 0.7)
